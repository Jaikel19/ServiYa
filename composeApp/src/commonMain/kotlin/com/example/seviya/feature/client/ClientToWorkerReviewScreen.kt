...
@Composable
fun ClientToWorkerReviewScreen(appointmentId: String, onBack: () -> Unit) {
  ...
  ClientToWorkerReviewContent(viewModel = viewModel, onBack = onBack)
}
...
private fun ClientToWorkerReviewContent(
  ...
  Column(
    ...
    Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
      (1..5).forEach { star ->
        Button(onClick = { viewModel.onRatingChanged(star) }) {
