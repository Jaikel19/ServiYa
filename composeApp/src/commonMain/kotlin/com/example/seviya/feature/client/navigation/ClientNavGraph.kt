...
fun NavGraphBuilder.clientNavGraph(
    ...
    composable<ClientDashboard> {
        ClientDashboardScreen(
            ...
            onOpenAppointmentDetail = { appointmentId ->
                navController.navigate(ClientAppointmentDetail(appointmentId = appointmentId))
            },
    ...
    composable<ClientAppointmentDetail> { backStackEntry ->
        ...
        ClientAppointmentDetailScreen(
            ...
            onBack = { navController.popBackStack() },
            onReviewClick = {
                navController.navigate(ClientToWorkerReview(appointmentId = route.appointmentId))
            },
            onGoDashboard = {
                onCurrentClientTabChange(ClientTab.DASHBOARD)
                navController.navigateSingleTop(ClientDashboard)
    ...
    composable<ClientDailyAppointments> { backStackEntry ->
        ...
        DailyAgendaScreen(
            ...
            onOpenDetail = { appointment ->
                navController.navigate(ClientAppointmentDetail(appointmentId = appointment.id))
            },
        )
    }
    ...
    composable<ClientAgenda> {
        MonthlyCalendarScreen(
            ...
            onOpenAppointmentDetail = { appointment ->
                ...
                navController.navigateSingleTop(ClientAppointmentDetail(appointmentId = appointment.id))
            },
        )
    }
