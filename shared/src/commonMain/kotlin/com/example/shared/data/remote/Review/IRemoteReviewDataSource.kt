...
interface IRemoteReviewDataSource {
  ...
  suspend fun markWorkerToClientReviewCreated(appointmentId: String, reviewId: String)

  suspend fun markClientToWorkerReviewCreated(appointmentId: String, reviewId: String)
}
