        ...
        viewModelScope.launch {
            ...
            try {
                ...
                val professionalProfile =
                    professionalProfileRepository.getProfessionalProfile(appointment.workerId).first()

                val cancellationPolicy = professionalProfile?.cancellationPolicy

                val worker = professionalProfile?.toWorkerProfile()

                val reviewMeta =
                    reviewMetaRepository.getReviewMeta(appointmentId).first() ?: ReviewMeta()
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                notificationsRepository.pushNotification(
                    ...
                    message = "${appointment.clientName} canceló la cita programada.",
...
private fun com.example.shared.domain.entity.ProfessionalProfileData.toWorkerProfile(): WorkerProfile {
